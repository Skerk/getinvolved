...
<head>
	...
	CSS STYLES
	=============================================== -->
	<link rel="stylesheet" href="{{ ('../../public/bootstrap/css/bootstrap.css') }}" type="text/css" media="screen" />
	<link rel="stylesheet" href="{{ ('../../public/css/page_animations.css') }}" type="text/css" media="screen" />
	<link rel="stylesheet" href="{{ ('../../public/css/magnific-popup.css') }}" type="text/css" media="screen" />
	<link rel="stylesheet" href="{{ ('../../public/css/elegant-font.css') }}" type="text/css" media="screen" />
	...
	Favicons
	=============================================== -->
	<link rel="apple-touch-icon-precomposed" sizes="144x144" href="{{ ('../../public/img/favicon/apple-touch-icon-144x144-precomposed.png') }}">
	<link rel="apple-touch-icon-precomposed" sizes="114x114" href="{{ ('../../public/img/favicon/apple-touch-icon-114x114-precomposed.png') }}">
	<link rel="apple-touch-icon-precomposed" sizes="72x72" href="{{ ('../../public/img/favicon/apple-touch-icon-72x72-precomposed.png') }}">
	<link rel="apple-touch-icon-precomposed" sizes="57x57" href="{{ ('../../public/img/favicon/apple-touch-icon-57x57-precomposed.png') }}">
	<link rel="shortcut icon" href="{{ ('../../public/img/favicon/favicon.png') }}" />

	<!-- DEMO Switcher
  	================================================== -->
	<link rel="stylesheet" href="{{ ('../../public/css/styleswitcher.css') }}" />
						...
						<div class="col-md-6">
							<div class="media">
								...
								<div class="media-body">
									...
									<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Morbi venenatis dictum tristique proin porta leo sed cursus
										condimentum.
									</p>
								</div>
							</div>
							...
							<div class="col-md-12 post">
								...
								<div class="post-right">
									<div class="post-image">
										<img id="monImage" src="{{('../../public/img/blog/1.jpg') }}'" class="img-responsive" alt="Get involved" />
									</div>
...
sont en train de changer !
	...
	================================================== -->
		...
		<script type="text/javascript" src="{{ ('../../public/js/circle-progress.js') }}"></script>
		...
		<script type="text/javascript" src="{{ ('../../public/js/map_script.js') }}"></script>
		...
		<script type="text/javascript" src="{{ ('../../public/js/video_youtube.js') }}"></script>
