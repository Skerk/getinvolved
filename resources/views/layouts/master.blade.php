			...
			<section id="marginbottom">
				<div class="container">
					<div class="row">
						...
						<h4><span aria-hidden="true" data-icon="&#xe108;"></span>  Manifesto</h4>
						<div class="clearfix"></div>
...
<p>What is the point to do something if it is not to make a change?</p>
							...
							<h1 id="movement" class="text-center">MOVEMENT IS TAKING PLACE</h1>
						</div>
...
<p class="textstat"><strong>Salvation : Bridge International Academies</strong></p>
<p class="textstat">They etablished in 2008 in Nairobi. Their mission is to provide a life-changing education to pupils. By working with governements, communities , teachers and parents they making sure these children receive an highly-quality and affordable education. Moreover that education allows them to fullfil their potential wich is according to BIA the key. Bridge was built as a changemaker. Millions of children around the world suffering from this status in wich school are expensive, unserviced and sometimes corrupted.
							...
							<div class="bar">
									...
									<a class="img-problem" target="_blank" href="http://www.flyzipline.com/"><img class="img-problem" src="{{ url('img/zip.jpg') }}" alt="statistique getinvolved"></a>
										<p class=""><strong>Problematic: Adequate access to essential medical products</strong></p>

<p class="textstat"><strong>Salvation : FlyZipLine</strong></p>
...
Chez nous il n'y a pas "celui qui aide" et "celui qui est aidé", il n'y a que des partenaires égaux, avec des parcours différents.</p>
									...
									<p><em>« 48.9% de Taux de pauvreté - 2.9% Taux annuel de croissance démographique- 9.8% Taux de
croissance du PIB (en 2012) - 0.43 Indicateur de développement humain - 61% Taux d’accès à l’eau
potable - 56.1% Taux net de scolarisation (primaire) » <strong>Source : PNUD</strong></em></p>
<br>
<br>
<p>Cependant, en Côte d’Ivoire un mouvement est en marche. Les projets de développement durable
...
sont en train de changer !</p>
<div class="row text-center">
	
	<button class="pt-trigger css3Animate btn btn-danger" data-animation="22" data-goto="6" data-style="lightNav" data-style2="contactNav">Je m'engage</button>
	<button type="button" class="btn btn-info" data-toggle="modal" data-target="#myModal">Plus d'infos</button>
						...
						<div class="col-md-12">
							...
							{{ csrf_field() }}
								...
								<div class="col-md-12 send-div">
									...
									<button class="btn btn-default css3Animate"  href="{{ url('/register')}}" title="Register here">Register</button>
								</div>
							</form>
